...
public class BookRestControllerTest {
    ...
    public void testCreateBook() throws Exception{
        String body = "{\"catId\":\"LL-000099\",\"title\":\"A Game of Thrones\",\"availability\":\"Available\",\"publisher\":\"HarperCollins Publishers\",\"author\":\"George R. R. Martin\",\"isbn\":\"9780006479888\",\"genre\":\"Fantasy\"}";
    ...
    public void testBookNotCreatedWithEmptyAuthor() throws Exception{
        String body = "{\"catId\":\"LL-000099\",\"title\":\"A Game of Thrones\",\"availability\":\"Available\",\"publisher\":\"HarperCollins Publishers\",\"isbn\":\"9780006479888\",\"genre\":\"Fantasy\"}";
        this.mockMvc.perform(post("/api-book/books").contentType(MediaType.APPLICATION_JSON_VALUE).content(body))
