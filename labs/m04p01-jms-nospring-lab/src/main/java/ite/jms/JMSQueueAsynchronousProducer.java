...
public class JMSQueueAsynchronousProducer {
	...
	public static void main(String[] args) throws NamingException {
        ...
        try(
           ...
           // TODO : Instruct Producer to send message asynchronously (do not wait for broker's acknowledge)
           jmsProducer.send(queue, "Hallo from JMS Producer!");
           logger.info("Message sent ...");
           // Not used in real application, as we want the current thread to continue
